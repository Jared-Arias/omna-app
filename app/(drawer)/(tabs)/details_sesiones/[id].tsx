...
import { getSesiones } from '@/services/auth/userDataController/authService';
    ...
    React.useCallback(() => {
      ...
      const fetchSessions = async () => {
        try {
          ...
          const res = await getSesiones(sessionId.toString());
    ...
    <SafeAreaView style={styles.maincontainer}>
      ...
      {loading && (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Cargando detalles de la sesión...</Text>
        </View>
      )}
      ...
      {sessionDetails && !loading && (
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.contentContainer}>
            ...
            {/* Imagen principal */}
            {sessionDetails.imagen1 && (
              <View style={styles.imageContainer}>
                <Image
                  source={{
                    uri: `https://omna.life/admin/ebook/uploads/sessions/${sessionDetails.imagen1}`
                  }}
            ...
            <View style={styles.longDescriptionContainer}>
              <Text style={styles.longDescription}>{sessionDetails.description_larga}</Text>
            </View>
            ...
            >
              <Text style={styles.buyButtonText}>Comprar sesión</Text>
            </TouchableOpacity>
...
export default Details_sessiones;
