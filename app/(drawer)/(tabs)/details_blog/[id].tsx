...
import { getBlogBySlug } from '@/services/auth/userDataController/authService';
    ...
    React.useCallback(() => {
      ...
      const fetchSessions = async () => {
        try {
          ...
          const res = await getBlogBySlug(slug.toString());
    ...
    <SafeAreaView style={styles.maincontainer}>
      ...
      {loading && (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Cargando detalles del Blog...</Text>
        </View>
      )}
